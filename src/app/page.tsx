...
const copy = {
  ...
  en: {
    ...
    heroNote: "Appointments run from 12 PM to 10 PM. Friday starts at 2 PM. Tuesday is closed.",
    ...
    servicesSubtitle: "Every service shows its price and duration upfront, and booking stays simple from start to finish.",
    ...
    serviceGroups: [
      {
        ...
        count: "6 services",
        items: [
          { code: "hair-beard-blowdry-scrub-mask", name: "Hair + Beard + Blow Dry", meta: "40 min", price: "7 JOD" },
