...
const copy = {
  ar: {
    ...
    heroNote: "تبدأ المواعيد من الساعة 12 ظهراً وحتى الساعة 10 مساءً. الجمعة من الساعة 2 مساءً، والثلاثاء عطلة.",
    ...
    visitNoteText: "اتصل بصالون سنبل على 0789299699. الإلغاء من الموقع غير متاح.",
    servicesEyebrow: "القائمة",
    servicesTitle: "دقة بالمواعيد واهتمام بالتفاصيل.",
    servicesSubtitle: "كل خدمة موضحة بسعرها ووقتها، والحجز يتم بخطوات واضحة بدون تعقيد.",
    productsEyebrow: "المنتجات",
    productsTitle: "منتجات موجودة في الصالون.",
    productsSubtitle: "الشراء من المحل فقط. اضغط على المنتج واقرأ التفاصيل.",
    ...
    serviceGroups: [
      {
        ...
        count: "6 خدمات",
        items: [
          { code: "hair-beard-blowdry-scrub-mask", name: "شعر + لحية + سشوار", meta: "40 دقيقة", price: "7 د.أ" },
  ...
  en: {
    ...
    heroNote: "Appointments are available from 12 PM to 10 PM. Friday from 2 PM to 10 PM. Closed on Tuesday.",
    location: "Get directions",
    imageAlt: "Inside Sonbol Salon",
    facts: [
      { label: "Booking", value: "Short steps" },
      { label: "Payment", value: "CLIQ SKH46" },
      { label: "Confirmation", value: "Once payment is received" },
    ],
    visitEyebrow: "Before your appointment",
    visitTitle: "From booking to chair, your experience stays seamless and straightforward.",
    visitText: "With Sonbol, booking is simple: select your service and time, complete payment through CLIQ, and receive your appointment confirmation instantly.",
    visitCards: [
    ...
    productsSubtitle: "Products are bought in-store only. Tap a product and read the details.",
    ...
    serviceGroups: [
      {
        ...
        count: "6 services",
        items: [
          { code: "hair-beard-blowdry-scrub-mask", name: "Haircut + Beard Trim + Blow Dry", meta: "40 min", price: "7 JOD" },
          { code: "haircut", name: "Haircut", meta: "30 min", price: "4 JOD" },
          { code: "beard", name: "Beard Trim", meta: "20 min", price: "3 JOD" },
          { code: "blowdry", name: "Blow Dry / Hair Styling", meta: "10 min", price: "2 JOD" },
          { code: "home-haircut", name: "Home Haircut Service", meta: "1 hr 30 min", price: "20 JOD" },
      ...
      },
      {
        ...
        items: [
          ...
          { code: "protein", name: "Protein", meta: "1 hr 30 min", price: "from 20 JOD" },
          { code: "skin-cleaning", name: "Facial Cleaning", meta: "1 hr 30 min", price: "15 JOD" },
        ],
      },
      {
        title: "Occasions",
        count: "1 service",
        items: [{ code: "groom-package", name: "Groom Package", meta: "3 hours" }],
      },
    ] satisfies ServiceGroup[],
  },
};
    ...
    >
      ...
      <section id="services" className="relative z-10 px-4 py-10 sm:px-6 lg:px-8 lg:py-16">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid items-start gap-4 md:grid-cols-2 lg:flex lg:items-start">
            {visibleServiceGroups.map((group, groupIndex) => (
              <article
                className="self-start animate-[rise_650ms_ease_both] rounded-lg border border-white/[0.18] bg-white/[0.045] p-4 shadow-[0_18px_58px_rgba(0,0,0,0.22)] backdrop-blur lg:flex-1"
